...
class TbkDgGeneralLinkConvertRequest
{
	...
	public function setQmtid($qmtid)
	{
		$this->qmtid = $qmtid;
		$this->apiParas["qmtid"] = $qmtid;
	}

	public function getQmtid()
	{
		return $this->qmtid;
	}
	...
	public function setUvid($uvid)
	{
		$this->uvid = $uvid;
		$this->apiParas["uvid"] = $uvid;
	}
